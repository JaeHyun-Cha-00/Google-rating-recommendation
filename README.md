...
1.  Download the dataset files (`review-Vermont_10.json.gz` and `meta-Vermont.json.gz`) from the UCSD Google Local Datasets page and place them in the root directory of the project.
